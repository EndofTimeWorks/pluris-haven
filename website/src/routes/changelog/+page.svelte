...
<main>
	...
	<section>
		...
		<p>
			This is the human-readable status page for the current mobile line. GitHub
			releases remain the source for APK files and exact tags.
		</p>
		<div class="actions">
	...
	<section>
		...
		<ul>
			...
			<li>Simply Plural, PluralKit, OpenPlural, Tupperbox, and PluralSpace import paths are available for testing.</li>
