...
<main>
  ...
  <section class="notes">
    ...
    <div>
      ...
      <p>
        This site hosts downloads, basic docs, privacy notes, and eventually the web UI. The web UI
        will live at <a href="/app">/app</a> once the shared data model is stable enough.
      </p>
    </div>
  </section>
