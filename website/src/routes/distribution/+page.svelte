...
<main>
	...
	<section>
		...
		<p>
			Pre-alpha builds ship through GitHub Releases so testing is not tied to a
			store account. Local use should stay available even if a hosted service or app
			store is not ready somewhere.
		</p>
	</section>
	...
	<section>
		...
		<p>
			If Android says the downloaded package does not match the installed app, the
