...
| Local chats, categories and channels                   | **SCAFFOLDED**                  | Tables, archive support, store/repository methods and basic local messages exist. Category/channel creation, navigation, global/system board, member walls, replies, author/front association, edit/history, visibly edited state, soft deletion and Safety wiring are not all reachable product flows. |
| Notes, journals and message revision history           | **PARTIAL**                     | Encrypted records and generic revision persistence/archive support exist. Markdown rendering/editing, automatic production writers, history/pin/restore UI, destructive revision safety and message history flows remain.                                                                               |
| Scoped local API                                       | **MISSING**                     | No versioned loopback service, explicit enable UX, client credentials, scopes, revocation, deterministic errors, repository/domain adapters, tests or operator/user docs exist.                                                                                                                         |
