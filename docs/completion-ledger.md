...
| Item                                         | State / maturity                  | Exact remaining layers                                                                                                                                                                                                                                                                                                |
| -------------------------------------------- | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reminders                                    | **PARTIAL**                       | Daily/weekly/monthly and after-front paths are reachable; after-front reminders can target a member or any front and configure a non-negative delivery delay; permission checks and notification-event recording are truthful. Queue/digest policy, timezone/recurrence edge coverage and delivery-history UX remain. |
